...
class Manager extends Employee {
  ...
  const managerOne = new Manager('Jess', 'weekday mornings, weekday afternoons', ['John', 'Alice']);
  managerOne.getSchedule();
  managerOne.getEmployees();
  managerOne.addEmployee('Bob');
  managerOne.getEmployees();
...
*/
   ...
   const managerTwo = new Manager('Winston', ['weekday mornings', 'weekday afternoons'], ['Cece', 'Schmidt']);
